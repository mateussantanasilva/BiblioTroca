...
export function SwitchTheme({ isHomeHeader = false }: SwitchThemeProps) {
  return (
    <Switch.Root
      id="change-theme"
      className={`relative w-[3.5rem] h-[1.563rem] rounded-full bg-gray-600
    ...
    >
      ...
      <Switch.Thumb
        className={`block absolute w-[1.25rem] h-[1.25rem] rounded-full top-[50%] translate-y-[-50%] left-1 data-[state=checked]:translate-x-[28px] z-10
